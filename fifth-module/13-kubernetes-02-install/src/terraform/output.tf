output "internal_ip_address_control-node" {
  value = "${yandex_compute_instance.control-node.network_interface.0.ip_address}"
}
output "external_ip_address_control-node" {
...
output "internal_ip_address_worker-04" {
  value = "${yandex_compute_instance.worker-04.network_interface.0.ip_address}"
}
output "external_ip_address_worker-04" {
  value = "${yandex_compute_instance.worker-04.network_interface.0.nat_ip_address}"
}