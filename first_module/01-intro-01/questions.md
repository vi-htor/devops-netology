...
1. Склонировать текущий репозиторий или просто создать файлы для проверки плагинов:
    - [netology.tf](test_files/netology.tf) – terraform,
    - [netology.sh](test_files/netology.sh) – bash,
    - [netology.md](test_files/netology.md) – markdown, 
    - [netology.yaml](test_files/netology.yaml) – yaml,
    - [netology.jsonnet](test_files/netology.jsonnet) – jsonnet.
